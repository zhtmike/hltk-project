...
java -cp HLTA.jar:HLTA-deps.jar tm.hlta.HLTA --show-log-time -s 10000 -g 1000 ./words/train/sample.sparse.txt 50 model_train_step
...
java -cp HLTA.jar:HLTA-deps.jar tm.hlta.HLTA --show-log-time -s 10000 -g 1000 ./words/full/sample.sparse.txt 50 model_full_step
